...
export default function EventList() {
    ...
    return (
            <div className='mt-[150px] max-w-6xl mx-auto'>
                {/* header */}
                <div className='flex justify-between'>
                        <p className='font-semibold text-3xl'>Lagos</p>
                        <div onClick={()=> router.push('/explore/events-cities')} className='flex gap-x-4 cursor-pointer items-center'>
