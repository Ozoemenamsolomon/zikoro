    ...
    return (
            <div className='mt-[100px] max-w-6xl mx-auto pb-24 px-3 lg:px-0'>
                ...
                <div className='flex justify-between'>
                        ...
                        <div onClick={()=> router.push('/explore/events-categories')} className='hidden lg:flex gap-x-4 cursor-pointer items-center'>
                ...
                <div onClick={()=> router.push('/explore/events-categories')} className='flex lg:hidden mt-[30px] justify-end gap-x-4 cursor-pointer items-center'>
                            <p className='bg-gradient-to-tr from-custom-gradient-start to-custom-gradient-end gradient-text text-xl font-semibold'>See All</p>
                            <RightArrow />
                </div>
            </div>
