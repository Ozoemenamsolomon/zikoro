...
export function SessionCard({
  ...
  return (
    <div
      className={cn(
        "w-full h-fit grid grid-cols-1 md:grid-cols-8 lg:grid-cols-10 gap-4 relative md:gap-14 items-center px-4 py-10 rounded-xl border sm:px-6 sm:py-16",
    ...
    >
      ...
      <div className="flex flex-col md:col-span-2 w-full pr-6 border-b-2 border-r-0 md:border-b-0 md:border-r-2 border-basePrimary items-start justify-start gap-y-1">
