...
export default function AppointmentSec5() {
  return (
    <div className="mt-[140px] bg-gradient-to-tr from-custom-gradient-start to-custom-gradient-end py-[115px] px-[99px] ">
      <div className="max-w-full xl:max-w-[82rem] mx-auto">
