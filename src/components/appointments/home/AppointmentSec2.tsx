...
export default function AppointmentSec2() {
  ...
  return (
    <div className=" px-3 lg:px-0 mt-[60px] flex flex-col lg:flex-row justify-between max-w-full xl:max-w-[97rem] mx-auto  ">
      {/* left */}
      <div className="w-[33%]">
        <Image
      ...
      <div className="flex flex-col justify-between w-[33%]">
        ...
        <Image src="/appointments/woman.png" width={449} height={375} alt="" />
      </div>
