  ...
  return (
    <div className=" space-y-4">
      ...
      <div className={`${isPaidAppointment ? 'max-h-screen visible':'max-h-0 invisible overflow-hidden'}  relative z-30 transform  transition-all duration-300 pb-4`}>
        <p className='pb-2 label'>Set pricing and currency</p>
      ...
      <div>
        <div className="rounded-md space-y-4 bg-slate-50 border relative p-4 pt-6 ">
              <h5 className="label px-1 bg-slate-5 absolute -top-3 bg-slate-50 left-3 ">Category 1</h5>
              <InputCustom
              ...
              <div className={`${isPaidAppointment ? 'max-h-screen visible':'max-h-0 invisible  overflow-hidden' } transform relative z-10 transition-all duration-300 pb-4`}>
