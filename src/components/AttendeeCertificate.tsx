  ...
  useEffect(() => {
    ...
    if (
      ...
      console.log(
        "hash set",
        certificate,
        lz.decompress(lz.decodeBase64(certificate.certficateDetails.craftHash))
      );
    }
  }, [isLoading]);
        ...
        <div className="flex justify-center [&>*]:scale-75">
          <div
            ...
            style={{
              ...
              backgroundImage: !!selectedCertificate?.certficateDetails
                .background
                ? `url(${selectedCertificate?.certficateDetails.background})`
                : "",
              backgroundColor: "#fff",
              width: "90%",
              height: "750px",
