            ...
            <div className='mt-5 lg:mt-24 bg-gradient-to-tr from-custom-gradient-start to-custom-gradient-end px-5 lg:px-0 '>
                    <div className=''>
                        ...
                        <div className='flex justify-center items-center text-white mt-12 pb-32 space-x-6'>
                                    <button onClick={() => router.push('/home')} className='cursor-pointer bg-gradient-to-tr from-custom-gradient-start to-custom-gradient-end text-sm lg:text-base py-4 px-5 rounded-md border-[.5px] border-white'> Get Started</button>
