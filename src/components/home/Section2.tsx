...
export default function Section2() {
    return (
            ...
            <div className='mt-20 max-w-full mx-auto lg:max-w-6xl px-5 '>
                        <p className='gradient-text font-bold bg-gradient-to-tr from-custom-gradient-start to-custom-gradient-end text-center text-2xl lg:text-4xl'>Made for people. <br/> Built for engagements and connections.</p>
