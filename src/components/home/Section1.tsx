...
export default function Section1() {
  ...
  return (
    <div className="mt-24 lg:mt-48 px-5 block">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-10 flex items-center justify-center mx-auto">
                <button onClick={() => router.push('/api/auth/login')} className="text-white font-montserrat text-base bg-gradient-to-tr from-custom-gradient-start to-custom-gradient-end py-4 px-5 rounded-lg">Get Started For Free!</button>
            </div>
