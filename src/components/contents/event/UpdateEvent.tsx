            ...
            img.onload = () => {
              ...
              setOrganisationLogoArr((prev) => [
                ...prev,
                {
                  ...
                  file: logo[0],
                  isValid: img.naturalHeight >= 500 && img.naturalWidth >= 1000,
                },
              ]);
            };
          ...
          >
            ...
            <div className="w-full grid grid-cols-1 items-center md:items-start md:grid-cols-2 gap-6">
                    ...
                    return (
                      <div className=" relative w-32 h-32" key={index}>
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 bg-red-500 rounded-full text-white w-6 h-6 flex items-center justify-center"
                        >
                          <CloseCircle size={16} />
                        </button>
                        {!isValid && (
              ...
              <div className="px-4 space-y-6">
                <TextEditor defaultValue={data?.description} onChange={handleChange} />
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <InputOffsetLabel label="Attendee Type">
                              <Input
                                type="text"
                                placeholder="Enter the attendee type"
                                {...form.register(
