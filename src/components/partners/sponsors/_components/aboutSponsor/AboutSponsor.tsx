    ...
    <>
      ...
      <section className="w-full flex flex-col  pb-2 border-b">
        ...
        <div className="items-start px-3 py-4 justify-start flex w-full flex-col gap-y-2">
          <p className="mb-4 font-semibold text-base sm:text-xl">Paystack</p>
          <div className="w-full flex flex-col items-start justify-start leading-6 text-[#717171]">
            Lorem ipsum dolor sit amet consectetur. Commodo dis mi augue gravida
            blandit vestibulum lorem. Fermentum semper blandit rhoncus tincidunt
            ante blandit eu. Pulvinar sit adipiscing felis orci vestibulum
            congue. Auctor elit quis ipsum pharetra cursus. Iaculis lectus
            magnis quam quisque mauris eget. Pellentesque id enim a justo purus
            aliquet sed lacus. Dui hendrerit ut vestibulum ultrices at faucibus.
          </div>
