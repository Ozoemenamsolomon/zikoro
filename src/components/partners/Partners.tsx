        ...
        <div className="parent-container relative w-full overflow-x-auto no-scrollbar">
          <div className="min-w-[800px] flex items-center justify-between p-4">
            <div className=" w-[90%] flex items-center">
              <button className="hidden  items-center  relative hover:text-basePrimary  w-fit px-3  text-[#D6D6D6]  gap-x-1">
                <IndustryIcon />
                <p className="">Company Name </p>
              </button>
              <button
                onClick={() => setShowLocationDropDown((prev) => !prev)}
                className="flex relative items-center hover:text-basePrimary w-fit px-3 border-x text-[#D6D6D6]  gap-x-1"
              >
                <LocationOn size={16} />
                <p>Location </p>
                {isLocationDropDown && (
              ...
              <button
                ...
                className="flex relative items-center hover:text-basePrimary w-fit px-3 border-r  text-[#D6D6D6]  gap-x-1"
              >
                <Briefcase size={16} />
                <p>Industry</p>
              ...
              <button className="flex relative items-center hover:text-basePrimary w-fit px-3 border-r text-[#D6D6D6]  gap-x-1">
              ...
              <button
                ...
                className={cn(
                  "flex relative items-center hover:text-basePrimary w-fit px-3 text-[#D6D6D6]  gap-x-1",
                  isStamp && "text-basePrimary"
                )}
              >
                <Stamp size={16} />
                <p>StampCard </p>
