...
export function ShareModal({ link , close}: {close:() => void; link: string }) {
  ...
  return (
    <div className="w-full full inset-0 fixed bg-white/40 z-[100]">
      <div className="w-[95%] max-w-3xl rounded-lg bg-white shadow absolute inset-0 h-fit max-h-[85%] flex flex-col overflow-y-auto no-scrollbar box-animation m-auto p-4 sm:p-6">
        <Button
          onClick={close}
        ...
        <div className="flex flex-col items-center justify-center gap-y-5 sm:gap-y-8">
          ...
          <div className="w-full  gap-4 flex flex-wrap items-start justify-start">
            <button
              onClick={copyLink}
