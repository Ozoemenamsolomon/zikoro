...
export default function PostArticle({
  ...
  return (
    <div
      onClick={goToPost}
      className="flex flex-col cursor-pointer h-[160px] w-[335px]  lg:w-[524px] lg:h-[240px] gap-y-6 lg:gap-y-16 "
    >
      <Image
      ...
      <Image
        ...
        width={335}
        height={160}
        className="block lg:hidden rounded-lg w-full h-full object-cover"
      />
