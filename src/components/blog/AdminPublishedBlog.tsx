...
import { AdminBlogShareIcon2, AdminBlogViewIcon2, ThreeDotsIcon } from "@/constants/icons";
...
function AdminPublishedBlog({id, title, createdAt, category, status, statusDetails, readingDuration, content, views, shares}: BlogPostProps) {
