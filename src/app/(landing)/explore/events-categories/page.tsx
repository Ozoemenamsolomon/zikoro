...
export default function EventsCategories() {
    ...
    return (
        <div  className={`${montserrat.className}`}>
            <Navbar/>
                {/* header */}
                    <div className='px-5 lg:px-0 max-w-full lg:max-w-6xl mx-auto pb-12 mt-24 lg:mt-48'>
                            ...
                            {/* Events categories */}
                            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-5 lg:gap-y-12 mt-12 lg:mt-24 px-10 lg:px-0'>
                                <CategoryEvent/>
                                <CategoryEvent/>
                                <CategoryEvent/>
                                <CategoryEvent/>
