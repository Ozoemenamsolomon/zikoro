    ...
    <section className="grid grid-cols-10 gap-2">
      ...
      <section className="col-span-4">
        <div className=" flex justify-end p-4 space-x-1 items-center">
          ...
          <span className=" text-sm text-ash">Early bird</span>
        </div>
        <section className=" flex flex-col items-center justify-center text-center">
          ...
          <h3 className=" text-greyBlack font-semibold">Adbur-rasheed Idris</h3>
        ...
        <div className=" flex justify-between my-4">
          <div className=" flex flex-col gap-2 items-center">
            ...
            <span className=" text-small text-[#3E404B] font-semibold">
              Add contact
            </span>
          </div>
          <div className=" flex flex-col gap-2 items-center">
        ...
        <div className="my-2 flex justify-between pt-4 pb-[15px] pl-[22px] pr-[20px] border-t-[1px] border-b-[1px] border-[#F3F3F3]">
          <h3 className="leading-[145%] text-greyBlack text-xl">Credentials</h3>
          <Link href="/" className="  text-sm text-[#001FCC] ">
            Recall certificate
          </Link>
        </div>
        <div className=" flex justify-between items-center px-6 py-[26px]">
        ...
        <section className=" px-6 py-3 space-y-6 ">
          <div className=" flex flex-col">
            ...
            <span className=" text-[#3E404B] text-sm ">MTN</span>
          </div>
          <div className="">
            <h4 className="text-[#222] leading-normal font-medium">Bio</h4>
            <p className="text-[#3E404B] text-sm font-normal">
              I&apos;m an enthusiastic and goal driven professional with passion
              to help people lead quality lives. With a background in
              Biomechanics, Sports and Medical Technology, I analyse and
              optimize human performance at work, during sports and activity of
              daily living; including human interractions with technical
              devices.
            </p>
          </div>
          <div className=" flex flex-col">
            ...
            <span className=" text-[#3E404B] text-sm ">Lagos,Nigeria</span>
          </div>
          <div className=" flex flex-col">
            <h4 className=" text-[#222] leading-normal font-medium">
              Social Media
          ...
          <div className=" flex justify-between bg-[#FAFAFA] p-2 rounded-[4px]">
            <div className=" flex gap-2 items-center">
              <span className=" font-medium text-greyBlack">Reisin mould</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
