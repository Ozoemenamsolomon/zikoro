      ...
      <section className="col-span-3 pt-2">
        <div className="flex justify-between items-end px-2 mb-2">
          ...
          <button className="px-3 py-2 rounded-md flex gap-3 bg-[#3F845F] text-white items-center">
            ...
            <span className="text-sm font-medium">12300 pts</span>
          </button>
        </div>
        <section className=" bg-[#F3F3F3] p-4">
          <div className=" rounded-lg flex bg-white gap-2.5 flex-wrap">
            {mapp}
          </div>
          <h3 className=" text-lg font-semibold text-greyBlack mt-[33px] mb-4">
            How to earn points
          </h3>
