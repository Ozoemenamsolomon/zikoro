        ...
        <>
          ...
          <section className="space-y-4 border-t-[1px] border-slate-200 pt-4">
            ...
            <div className="space-y-4 px-2">
              ...
              <div className="">
                <h4 className="text-slate-800 font-medium">Bio</h4>
                <p className="text-slate-700 text-sm font-normal">
                  {attendee.bio}
                </p>
              </div>
              <div className="flex flex-col">
                <h4 className="text-slate-800 font-medium">Location</h4>
                <span className=" text-slate-700 text-sm">
                  {attendee.city + ", " + attendee.country}
                </span>
              </div>
              <div className="flex flex-col">
                <h4 className="text-slate-800 font-medium">Social Media</h4>
          ...
          <section className="border-t-[1px] border-slate-200 space-y-4 pt-4">
            <div className="flex justify-between items-center border-b-[1px] border-slate-200 pb-2 px-2">
              ...
              <div className="flex space-x-1">
                ...
                <button onClick={onOpenNotesForm}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
