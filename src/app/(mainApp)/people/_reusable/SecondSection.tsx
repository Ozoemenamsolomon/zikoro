    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center text-center px-4">
        <div className="text-white relative w-12 h-12 rounded-[50%] bg-[#D9D9D9] flex justify-center items-center mb-4">
          ...
          >
            <path
              d="M7.75 9.6665C8.85457 9.6665 9.75 8.77107 9.75 7.6665C9.75 6.56193 8.85457 5.6665 7.75 5.6665C6.64543 5.6665 5.75 6.56193 5.75 7.6665C5.75 8.77107 6.64543 9.6665 7.75 9.6665Z"
              stroke="#717171"
              stroke-width="1.5"
            />
            <path
              d="M6.26858 13H9.23125C11.3119 13 12.3526 13 13.0999 12.51C13.4224 12.2987 13.7001 12.0259 13.9173 11.7074C14.4166 10.974 14.4166 9.95203 14.4166 7.90936C14.4166 5.86603 14.4166 4.8447 13.9173 4.11136C13.7001 3.79277 13.4224 3.52003 13.0999 3.3087C12.6199 2.99336 12.0186 2.8807 11.0979 2.8407C10.6586 2.8407 10.2806 2.51403 10.1946 2.0907C10.1289 1.78061 9.9581 1.50272 9.71115 1.304C9.4642 1.10527 9.15622 0.997903 8.83925 1.00003H6.66059C6.00192 1.00003 5.43459 1.4567 5.30525 2.0907C5.21925 2.51403 4.84125 2.8407 4.40192 2.8407C3.48192 2.8807 2.88059 2.99403 2.39992 3.3087C2.07766 3.52007 1.80017 3.79281 1.58325 4.11136C1.08325 4.8447 1.08325 5.86603 1.08325 7.90936C1.08325 9.95203 1.08325 10.9734 1.58259 11.7074C1.79859 12.0247 2.07592 12.2974 2.39992 12.51C3.14725 13 4.18792 13 6.26858 13Z"
              stroke="#717171"
              stroke-width="1.5"
            />
            <path
              d="M12.4167 5.6665H11.75"
              stroke="#717171"
              stroke-width="1.5"
