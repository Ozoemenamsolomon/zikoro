      ...
      >
        ...
        >
          <section className="absolute w-full h-full [backface-visibility:_hidden] top-0">
            ...
            >
              <img
                ...
                alt="design"
                className="grayscale bottom-0 left-0 absolute"
              />
              <div className="flex justify-center gap-4">
                ...
                <div className="flex-1 flex flex-col gap-2 text-left h-full">
                  ...
                  <div className="uppercase">
                    {jobTitle && <h4 className="text-grayBlack">{jobTitle}</h4>}
                    {organization && (
                      <h4 className="text-gray-500 text-sm">{organization}</h4>
                    )}
                  </div>
          ...
          <section className="[transform:_rotateY(180deg)] absolute [backface-visibility:_hidden] top-0 h-full w-full bg-gray-50 flex gap-2">
            <div className="pt-8 pb-4 px-6 grid grid-cols-2 justify-center items-center gap-8">
              ...
              <div className="flex h-full flex-col justify-between col-span-1">
                      ...
                      <DialogTrigger asChild>
                        <DropdownMenuItem key={eventCertificate.id}>
                          <button
                            ...
                            onClick={() =>
                              setCertificateId(eventCertificate.id)
                            }
                          >
