...
const Element = ({}: TabProps) => {
  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-2 items-center py-4 h-[200px] overflow-auto">
        <button
      ...
      <div className="space-y-2">
        <div className="flex flex-col gap-1">
          ...
          <div className="hidden">
            <Input
              ...
              type="file"
              onChange={(e) =>
                e.target.files && uploadElement(e.target.files[0])
              }
              accept="image/*"
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 py-4" ref={divRef}>
          {organization?.certificateAsset?.elements &&
            organization?.certificateAsset?.elements.map((url) => (
