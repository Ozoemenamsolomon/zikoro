...
const Certificates = () => {
  ...
  const Publish = ({ certificate }: { certificate: TCertificate }) => {
    const clsBtnRef = useRef<HTMLButtonElement>(null);
      ...
      <Dialog>
        <DialogTrigger asChild>
          <button
            ...
            onClick={(e) => e.stopPropagation()}
          >
            <span className="p-2">Publish Now</span>
          </button>
        </DialogTrigger>
        <DialogContent className="p-4 z-[1000]">
          <DialogHeader className="px-3">
            <DialogTitle></DialogTitle>
          </DialogHeader>
          <div className="flex flex-col gap-4 items-center py-4">
            ...
            <div className="text-gray-800 font-medium flex flex-col gap-2 text-center">
              <span>
                Are you sure you want to immediately publish this certificate?
                You will no longer be able to edit the certificate
              </span>
            </div>
  ...
  return (
    <div className="flex flex-col gap-2 px-2 py-4">
      ...
      <div className="md:grids-cols-2 lg:grid-cols-4 grid gap-4">
