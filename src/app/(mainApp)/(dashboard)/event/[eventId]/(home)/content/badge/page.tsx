...
const Badges = () => {
          ...
          <div className="space-y-8">
            <div className="flex flex-col gap-4 items-center py-4">
              ...
              <span className="text-gray-800 font-medium">
                Select the event to which you want to add this badge to
              </span>
            </div>
            ...
            <DialogClose asChild>
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  eventId && makeACopy(badge, eventId);
                }}
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-4 items-center py-4">
                ...
                <div className="text-gray-800 font-medium flex flex-col gap-2 text-center">
                  <span>Are you sure you want to delete this badge?</span>
                </div>
              </div>
  ...
  if ((badges && badges.length === 0) || isLoading)
    return (
