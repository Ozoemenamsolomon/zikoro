            ...
            <DialogClose asChild>
              <Button
                ...
                onClick={(e) => {
                  ...
                  eventId &&
                    router.push(
                      `/event/content/${eventId}/certificate/create`
                    );
                }}
                className="bg-basePrimary w-full"
              >
      ...
      <div className="flex flex-col h-96 w-full items-center justify-center gap-2">
        ...
        <Button
          onClick={(e) => {
            ...
            router.push(`/event/content/${eventId}/certificate/create`);
          }}
          className="bg-basePrimary flex gap-4 items-center w-fit py-2"
        >
          <svg
          ...
          ({
            ...
            <div className="relative h-full">
              ...
              <button
                ...
                onClick={() =>
                  router.push(`/event/content/${eventId}/certificate/create?certificateId=${id}`)
                }
              >
