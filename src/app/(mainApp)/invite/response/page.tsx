...
const page = () => {
  return (
    <main className="min-h-screen w-full flex flex-col bg-basePrimary/10 justify-between items-center">
      <div />
      <section className="flex py-8 px-4 w-4/5 md:w-2/5 bg-white flex-col items-center justify-center gap-4 rounded-2xl">
        ...
        <p className="text-xl text-gray-800 text-center">
          Thanks for your response, the event host will be notified shortly
        </p>
      </section>
